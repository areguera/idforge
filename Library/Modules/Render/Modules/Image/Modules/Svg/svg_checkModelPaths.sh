...
# Retrieves absolute paths from source files and checks their
# existence.
#
...
# create the background image using a plain color and crop from it
# then.  We can't go on without the required background information.
function svg_checkModelPaths {
    ...
    local BG_DST_FILE='' BG_DST_FILES=$(svg_printModelPaths "${FILE}")
