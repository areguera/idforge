...
*docbook-exports* configuration option (e.g., "manpage", "xhtml",
"pdf").
...
as value to *docbook-exports* the docbook module uses the system's
...
all docbook-exports and render-flow values provided in the
