...
*-m "NAME", --model="NAME"*::
    Specifies the name of the organization that you want to use as
    model to create the workplace. When this option is not provided, a
    selection list with all organizations possible names is displayed
