...
=== How to create tests for commands which don't produce content?
...
.Output related to new test creation
----------------------------------------------------------------------
...
and you just want to run +qatest-2014121344576579785.sh+ with both
file types and digests validations, then you need to run the following
command:

----------------------------------------------------------------------
IDFORGE_LIBEXECDIR=${PWD}/Libexec \
    ./idforge --filter="2014121344576579785" \
    qatest -c ./QaTests/idforge-qatest/create.sh -fg ./Qatests/idforge-qatest
----------------------------------------------------------------------
