...
The *idforge-render(1)* command sends electronic mails when
...
The *idforge-render(1)* command needs you to create a working
directory using the *idforge-prepare(1)* command and update the
following files based on the visual style and branding information you
want to set for your organization:
